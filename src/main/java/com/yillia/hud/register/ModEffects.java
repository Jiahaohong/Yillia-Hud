...
import com.yillia.hud.effect.RecoveryEffect;
...
public class ModEffects {
    ...
    public static final RegistryObject<MobEffect> RECOVERY = EFFECTS.register("recovery",
            () -> new RecoveryEffect(MobEffectCategory.BENEFICIAL, 3124687));
